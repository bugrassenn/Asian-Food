...
// Bütün yemekleri listeleyen fonksiyon
const listAllFoods = () => {
  let allFoods = "";
...
// Kore yemekleri listeyen fonksiyon
const listOfKoreaFoods = () => {
  let koreaFoods = "";
  ...
  menuList.innerHTML = koreaFoods;
};

// japon yemeklerini listeleyen fonksiyon
...
// Çin yemeklerini listeleyen fonksiyon
...
// bütün yemeklerilisteleme
const btnAllFoods = document.querySelector("#all");
const btnKoreaFoods = document.querySelector("#korea");
const btnJapanFoods = document.querySelector("#japan");
const btnChineseFoods = document.querySelector("#china");

btnAllFoods.addEventListener("click", listAllFoods);
btnKoreaFoods.addEventListener("click", listOfKoreaFoods);
btnJapanFoods.addEventListener("click", listOfJapanFoods);
btnChineseFoods.addEventListener("click", listOfChineseFoods);